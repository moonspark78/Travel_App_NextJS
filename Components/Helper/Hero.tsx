    ...
    <div className='relative w-[100%] h-[88vh]'>
        ...
        <div className='absolute z-[100] w-[100%] h-[100%] top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]'>
            <div className='flex items-center justify-center flex-col w-[100%] h-[100%]'>
                <div>
                    <h1 className='text-[25px] mt-[0.3rem] mb-[1rem] md:mb-[0] text-center md:text-[35px] lg:text-[45px] tracking-[0.7rem] text-white
                    font-bold uppercase'>
                ...
                {/* SearchBox */}
                <SearchBox/>
                <a href="#_" className='rounded px-14 md:px-28 mt-[-1rem] py-2.5 overflow-hidden group bg-red-500 relative
